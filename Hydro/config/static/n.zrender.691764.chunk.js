;{try{(function(){var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="28a18bf1-c01e-4116-a0d9-c007abd3f1c1",e._sentryDebugIdIdentifier="sentry-dbid-28a18bf1-c01e-4116-a0d9-c007abd3f1c1");})();}catch(e){}};
...
var DEFAULT_TSPAN_STYLE = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.defaults)({
  strokeFirst: true,
...
var TSpan = function(_super) {
  ...
  TSpan2.prototype.createStyle = function(obj) {
    return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.createObject)(DEFAULT_TSPAN_STYLE, obj);
  };
  ...
  TSpan2.prototype.getBoundingRect = function() {
    ...
    if (!this._rect) {
      var text = style.text;
      text != null ? text += "" : text = "";
      var rect = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getBoundingRect)(text, style.font, style.textAlign, style.textBaseline);
      rect.x += style.x || 0;
      rect.y += style.y || 0;
      if (this.hasStroke()) {
        var w = style.lineWidth;
...
var ZRText = function(_super) {
  ...
  ZRText2.prototype._updatePlainTexts = function() {
    ...
    var contentBlock = (0,_helper_parseText_js__WEBPACK_IMPORTED_MODULE_1__.parsePlainText)(text, style);
    ...
    for (var i = 0; i < textLines.length; i++) {
      ...
      if (fixedBoundingRect) {
        el.setBoundingRect(new _core_BoundingRect_js__WEBPACK_IMPORTED_MODULE_7__["default"]((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextX)(subElStyle.x, contentWidth, subElStyle.textAlign), (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextY)(subElStyle.y, calculatedLineHeight, subElStyle.textBaseline), contentWidth, calculatedLineHeight));
      }
    }
  };
  ZRText2.prototype._updateRichTexts = function() {
    var style = this.style;
    var text = getStyleText(style);
    var contentBlock = (0,_helper_parseText_js__WEBPACK_IMPORTED_MODULE_1__.parseRichText)(text, style);
  ...
  ZRText2.prototype._placeToken = function(token, style, lineHeight, lineTop, x, textAlign, parentBgColorDrawn) {
    ...
    el.setBoundingRect(new _core_BoundingRect_js__WEBPACK_IMPORTED_MODULE_7__["default"]((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextX)(subElStyle.x, textWidth, subElStyle.textAlign), (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextY)(subElStyle.y, textHeight, subElStyle.textBaseline), textWidth, textHeight));
  };
...
function prepareTruncateOptions(containerWidth, font, ellipsis, options) {
  ...
  preparedOpts.cnCharWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)("\u56FD", font);
  var ascCharWidth = preparedOpts.ascCharWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)("a", font);
  ...
  var ellipsisWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(ellipsis, font);
...
function truncateSingleLine(out, textLine, options) {
  ...
  var lineWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(textLine, font);
  ...
  for (var j = 0; ; j++) {
    ...
    lineWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(textLine, font);
  }
  if (textLine === "") {
...
function parsePlainText(text, style) {
  ...
  var height = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(style.height, contentHeight);
  ...
  var contentWidth = 0;
  for (var i = 0; i < lines.length; i++) {
    contentWidth = Math.max((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(lines[i], font), contentWidth);
  }
  if (width == null) {
    width = contentWidth;
  }
  ...
  outer: for (var i = 0; i < contentBlock.lines.length; i++) {
    ...
    for (var j = 0; j < line.tokens.length; j++) {
      ...
      if (typeof styleTokenWidth === "string" && styleTokenWidth.charAt(styleTokenWidth.length - 1) === "%") {
        ...
        token.contentWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(token.text, font);
      } else {
        ...
        if (remainTruncWidth != null && remainTruncWidth < token.width) {
          if (!tokenWidthNotSpecified || remainTruncWidth < paddingH) {
            ...
            token.width = token.contentWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(token.text, font);
          }
        } else {
          token.contentWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(token.text, font);
        }
...
function pushTokens(block, str, style, wrapInfo, styleName) {
  ...
  for (var i = 0; i < strLines.length; i++) {
    ...
    if (typeof tokenStyle.width === "number") {
      ...
      token.width = linesWidths ? linesWidths[i] : (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(text, font);
    }
    if (!i && !newLine) {
...
function wrapText(text, font, lineWidth, isBreakAll, lastAccumWidth) {
  ...
  for (var i = 0; i < text.length; i++) {
    ...
    var chWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getWidth)(ch, font);
